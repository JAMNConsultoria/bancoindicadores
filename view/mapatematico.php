...
/* Declaração do Serviço de Mapas */
  ...
  click: function( e, geo ) {   
    ...
    if(objMapa.length > 0){
       ...
       $("#divInfLoc").html("<p>UF: "+nomeuf+"<p>Região: <b>"+nome+"</b><p><span style='padding:5px;background-color:"+cor+"'/> <b>"+nomegrupo+"</b>");
       listaMun(cod);
    }
...
<div id="grupodesc">
    ...
    <div style="width:auto;padding: 10px;text-align: right;border-top: 1px dotted #069">Para maiores detalhes consulte a <a href="pdf/relatorio_tipologias_versaojul2014.pdf" target="_blank">metodologia.</a></div>
</div>

<div id="divtabela">    
<h1>Principais Características dos Agrupamentos das Regiões de Saúde</h1>    
...
3=>"Médio desenvolvimento socioeconômico e média/alta oferta de serviços",
...
#inclusão de dados sobre Grandes Regiões em 25/07/2014 apenas para BRASIL
if(strtoupper($locnome)=="BRASIL" && strtoupper($grupo)=='GRUPO_SOCIO' ){
$arrDadosGR[13] = array(1=>27,2=>11,3=>3,4=>3,5=>0);
$arrDadosGR[14] = array(1=>115,2=>4,3=>8,4=>1,5=>5);
$arrDadosGR[15] = array(1=>25,2=>14,3=>62,4=>20,5=>32);
$arrDadosGR[16] = array(1=>2,2=>4,3=>43,4=>8,5=>11);
$arrDadosGR[17] = array(1=>6,2=>20,3=>7,4=>3,5=>2);

$arrLabelsDadosGR [13] = "Número de Regiões de Saúde (Região Norte)";
$arrLabelsDadosGR [14] = "Número de Regiões de Saúde (Região Nordeste)";
$arrLabelsDadosGR [15] = "Número de Regiões de Saúde (Região Sudeste)";
$arrLabelsDadosGR [16] = "Número de Regiões de Saúde (Região Sul)";
$arrLabelsDadosGR [17] = "Número de Regiões de Saúde (Região Centro-Oeste)";


$arrTab = array_merge ($arrTab,$arrDadosGR);
$labels = array_merge ($labels,$arrLabelsDadosGR);
}
#echo "<pre>";
#print_r($arrTab);
#print_r($labels);
