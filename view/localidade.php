        ...
        $(document).ready(function()     {
            ...
            <div id="conteudo">
                <div id="menu">
                    ...
                    <div id="menu_active">Indicadores por Tema</div>
                    <a href="pdf/relatorio_tipologias_versaojul2014.pdf" target="_blank" class="menu">Metodologia</a><!--a href="metodologia.php" target="_blank" class="menu">Metodologia</a--><br />
                    <!--a href="ficha.php" class="menu">Ficha T&eacute;cnica</a--><br />
                </div>
                
                <div id="corpo">
                    <div id="titulo">Indicadores por Tema</div><br /><br /><br/><br/>
